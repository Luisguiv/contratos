                    ...
                    <table className="w-full">
                        ...
                        <tbody className="bg-gray-800">
                            ...
                            <tr key={index} className="text-gray-200">
                              <td className="px-4 py-3 text-ms font-semibold border">{item.empresa.nome}</td>
                              <td className="px-4 py-3 text-ms font-semibold border">{item.valorContratado}</td>
                              <td className="px-4 py-3 text-sm border">{item.dataInicio}</td>
                              <td className="px-4 py-3 text-sm border">{item.dataFim}</td>
